  ...
  _buildUser()
  {
    return Container(
      ...
      child: InkWell(
        ...
        child: Row(
          children: [
            CircleAvatar(backgroundImage: post.user.photoUrl == null? NetworkImage("https://firebasestorage.googleapis.com/v0/b/cs310-project-cc354.appspot.com/o/unknown.jpg?alt=media&token=71503f0d-a3c9-4837-b2e0-30214a02f0e2"): NetworkImage(post.user.photoUrl),),
            SizedBox(width: 10,),
